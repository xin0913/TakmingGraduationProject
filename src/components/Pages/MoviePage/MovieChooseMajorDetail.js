...
const MovieChooseMajorDetail = ({Wallet}) => {
    ...
    const getPersonalProfile = async () => {
        ...
        const res = await fetch('http://192.192.140.209:9453/react/movie/profile/select/uid',{
            method: 'POST',
            body: Request,
            credentials: 'omit'
        })
    ...
    const getPersonalProject = async () => {
        ...
        const res = await fetch('http://192.192.140.209:9453/react/movie/project/select/uid',{
            method: 'POST',
            body: Request,
            credentials: 'omit'
        })
    ...
    const invite = () => {
        ...
        fetch('http://192.192.140.209:9453/react/movie/invitation/add/finish',{
            method: 'POST',
            body: Request,
            credentials: 'omit'
        })
...
export default MovieChooseMajorDetail